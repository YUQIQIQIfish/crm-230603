...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#logoutBtn").click(function (){
			//发送同步请求
			window.location.href = "setting/qx/user/logout.do";
		});
...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;yqq&nbsp;crm项目</span></div>
