...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#queryActivityBtn").click(function (){
			//查询所有符合条件数据的第一页以及所有符合条件的总条数
			queryActivityByConditionForPage(1,$("#demo_pag1").bs_pagination('getOption','rowsPerPage'));
		});

		//给全选按钮加单击事件
		$("#checkAll").click(function (){
			//如果"全选"按钮选中，则列表所有checkBox都选中
		...
		$("#tBody").on("click","input[type='checkbox']",function (){
			//如果列表中所有的checkbox都选中，则全选选中，否则不选中
		...
		$("#importActivityBtn").click(function (){
			...
			$.ajax({
				...
				data:formData,
				processData:false,//设置ajax向后台提交参数，是否把参数统一转换为字符串，默认为true
				contentType:false,//设置ajax向后台提交参数，是否把参数统一转按照urlencodeed编码，默认为true
				type:'post',
				dataType:'json',
				success:function (data){
					if (data.code=="1"){
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button type="button" class="btn btn-default" id="editActivity"></span> 修改</button>
...
<%--				<div>--%>
<%--					<button type="button" class="btn btn-default" style="cursor: default;">共<b id="count">50</b>条记录</button>--%>
<%--				</div>--%>
